...
- **490 non-slow pytest tests pass** (1 skip intentional); **12 / 14 slow pass**
...
```powershell
pytest tests/ -m "not slow"   # 490 pass / 1 skip; ~30 s (test_fetchers.py needs the respx dev dep)
