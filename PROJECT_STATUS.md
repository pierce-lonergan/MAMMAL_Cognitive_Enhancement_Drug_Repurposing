...
| Metric | Value | Status |
|---|---|---|
| Pytest pass rate (non-slow) | **502** pass / 1 skip (+83 across Gaps 1–7 + grid expansion + panel→31 + review rounds 2–4 (comparators, temporal, taxonomy, calibration, prospective, expansion); `test_fetchers.py` needs the `respx` dev dep) | ✅ |
...
├── tests/                        502 non-slow pytest cases + 14 slow (33 files)
