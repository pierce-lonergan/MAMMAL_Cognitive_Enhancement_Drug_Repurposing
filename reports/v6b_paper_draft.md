...
**Reports**: `reports/cluster_d_nuts_v1.md` (full per-target table + convergence diagnostics + honest caveats).
...
**Pre-registration**: `reports/v7_osf_preregistration.md` (V7 layer) and pending OSF lock for V6.B.4 Stage 2 + V6.B.5 expanded panel.
...
*Generated by `reports/v6b_paper_draft.md`. Status: outline draft v1, V6.B.3 production NUTS converged. Next: validate Gate 2 Spearman live + expand to V6.B.5 ~210-target panel before submission.*
