...
This is a **within-library outlier** test, not an absolute affinity test, and is sensible for MAMMAL given its known prior collapse. The absolute-mode artifacts (`reports/liability_audit_v1_absolute.md`, `data/results/v2/liability_gates_absolute.parquet`) are preserved as evidence of the calibration mismatch.
