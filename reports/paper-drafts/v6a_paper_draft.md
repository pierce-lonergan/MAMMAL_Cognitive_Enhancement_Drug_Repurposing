...
Reports: `reports/pipeline/mmatt_dta_activation_v1.md` (full empirical table + Tier-A FAIL framing) + `reports/pipeline/disagreement_axis_v1.md` (603 high-info pairs).
...
*Generated by `reports/paper-drafts/v6a_paper_draft.md`. Companion to `reports/paper-drafts/v6b_paper_draft.md` (V6.B), `reports/paper-drafts/v7_osf_preregistration.md` (V7), `reports/paper-drafts/v8_osf_preregistration.md` (V8).*
