...
`reports/paper-drafts/methodology_v1.md` (V3-era doc with post-ship update banners). Mirrors
...
The absolute-mode artifacts (`reports/pipeline/liability_audit_v1_absolute.md`,
...
Production deliverable: `reports/wet-lab/wet_lab_shortlist_v6_full.md` — composes
...
12. §8.10 nootropic-similarity annotation + §40 ClinicalTrials.gov IP status
    + §8.15 Tanimoto-vs-MAMMAL disagreement tag
        ...
        ▼
13. THE V5 wet-lab handoff: reports/wet-lab/wet_lab_shortlist_v6_full.md
