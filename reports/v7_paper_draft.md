...
**OSF pre-registration**: `reports/v7_osf_preregistration.md` (locked before unblinding)
...
Reports: `reports/v7_nuts_v1.md` (full NUTS Gate 1-3 + sensitivity sweep + per-compound LOO MAE table).

OSF pre-registration: `reports/v7_osf_preregistration.md` (priors, predictions, gates, falsifiability, publication plan locked).
...
*Generated by `reports/v7_paper_draft.md`. Companion to `reports/v6a_paper_draft.md` (V6.A), `reports/v6b_paper_draft.md` (V6.B), `reports/v7_osf_preregistration.md` (V7), `reports/v8_osf_preregistration.md` (V8). V7.5 Stage 1 outline.*
