...
1. Convert the manuscript to PDF. The markdown is submission-formatted; a PDF can be produced from `manuscript_class_prognostic_biorxiv.md` (ask Claude to generate a PDF via the pdf skill, or use pandoc: `pandoc manuscript_class_prognostic_biorxiv.md -o manuscript.pdf`).
