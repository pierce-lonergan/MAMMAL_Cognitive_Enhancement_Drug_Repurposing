...
|---|---|---|---|---|---|---|---|
| 1 | methylphenidate | positive_control | 1.327 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 2 | bupropion | extended_cns | 1.296 | 7.73 (Q16620) | PASS | PASS | **PASS** |
| 3 | d-amphetamine | positive_control | 1.274 | 8.74 (P23975) | PASS | PASS | **PASS** |
| 4 | aniracetam | named_in_research | 1.264 | 7.62 (Q13224) | PASS | PASS | **PASS** |
| 5 | pramiracetam | extended_cns | 1.244 | 9.57 (P48058) | PASS | FLAG | **FLAG** |
| 6 | rivastigmine | positive_control | 1.236 | 8.37 (P48058) | PASS | PASS | **PASS** |
| 7 | levetiracetam | extended_cns | 1.229 | 9.01 (P23975) | PASS | PASS | **PASS** |
| 8 | modafinil | positive_control | 1.209 | 8.33 (P42261) | PASS | FLAG | **FLAG** |
| 9 | rasagiline | extended_cns | 1.205 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 10 | donepezil | positive_control | 1.182 | 8.33 (P42261) | FLAG | PASS | **FLAG** |
| 11 | lisdexamfetamine | extended_cns | 1.181 | 7.82 (Q08499) | PASS | PASS | **PASS** |
| 12 | selegiline | extended_cns | 1.174 | 7.73 (Q16620) | PASS | PASS | **PASS** |
| 13 | pridopidine | named_in_research | 1.174 | 8.12 (P08913) | PASS | PASS | **PASS** |
| 14 | atomoxetine | positive_control | 1.161 | 8.84 (P48058) | FLAG | PASS | **FLAG** |
| 15 | lanicemine | named_in_research | 1.160 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 16 | encenicline | named_in_research | 1.157 | 8.33 (P42261) | FLAG | PASS | **FLAG** |
| 17 | cx-717 | named_in_research | 1.156 | 8.82 (Q99720) | FLAG | PASS | **FLAG** |
| 18 | guanfacine | extended_cns | 1.154 | 7.73 (Q16620) | PASS | PASS | **PASS** |
| 19 | riluzole | named_in_research | 1.154 | 8.16 (Q01959) | FLAG | PASS | **FLAG** |
| 20 | aripiprazole | positive_control | 1.150 | 9.18 (Q12879) | FLAG | CUT | **CUT** |
| 21 | ropinirole | extended_cns | 1.149 | 7.82 (Q08499) | FLAG | PASS | **FLAG** |
| 22 | pramipexole | extended_cns | 1.148 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 23 | cx-516 | named_in_research | 1.147 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 24 | risperidone | extended_cns | 1.144 | 9.14 (Q12879) | FLAG | CUT | **CUT** |
| 25 | memantine | named_in_research | 1.143 | 9.01 (P23975) | PASS | PASS | **PASS** |
...
|---|---|---|---|---|---|
| 1 | methylphenidate | positive_control | 1.327 | 8.16 (Q01959) | — |
| 2 | bupropion | extended_cns | 1.296 | 7.73 (Q16620) | — |
| 3 | d-amphetamine | positive_control | 1.274 | 8.74 (P23975) | — |
| 4 | aniracetam | named_in_research | 1.264 | 7.62 (Q13224) | — |
| 5 | rivastigmine | positive_control | 1.236 | 8.37 (P48058) | — |
| 6 | levetiracetam | extended_cns | 1.229 | 9.01 (P23975) | — |
| 7 | rasagiline | extended_cns | 1.205 | 8.16 (Q01959) | — |
| 8 | lisdexamfetamine | extended_cns | 1.181 | 7.82 (Q08499) | — |
| 9 | selegiline | extended_cns | 1.174 | 7.73 (Q16620) | — |
| 10 | pridopidine | named_in_research | 1.174 | 8.12 (P08913) | — |
| 11 | lanicemine | named_in_research | 1.160 | 8.16 (Q01959) | — |
| 12 | guanfacine | extended_cns | 1.154 | 7.73 (Q16620) | — |
| 13 | pramipexole | extended_cns | 1.148 | 8.16 (Q01959) | — |
| 14 | cx-516 | named_in_research | 1.147 | 8.16 (Q01959) | — |
| 15 | memantine | named_in_research | 1.143 | 9.01 (P23975) | — |
| 16 | piracetam | extended_cns | 1.132 | 8.84 (P48058) | — |
| 17 | galantamine | positive_control | 1.128 | 8.33 (P42261) | — |
| 18 | ibuprofen | negative_control | 1.120 | 7.82 (Q08499) | — |
| 19 | rolipram | positive_control | 1.119 | 7.83 (P42262) | — |
| 20 | atenolol | negative_control | 1.113 | 7.82 (Q08499) | — |
| 21 | chembl1255723 | chembl_expanded | 1.113 | 9.01 (P23975) | — |
| 22 | clonidine | extended_cns | 1.110 | 9.57 (P48058) | — |
| 23 | chembl1256414 | chembl_expanded | 1.110 | 8.82 (Q99720) | — |
| 24 | chembl302231 | chembl_expanded | 1.107 | 9.01 (P23975) | — |
| 25 | chembl1256378 | chembl_expanded | 1.107 | 9.57 (P48058) | — |
...
|---|---|---|---|---|---|---|
| 5 | pramiracetam | 1.244 | 9.57 (P48058) | PASS | FLAG | Tier 2 z≥1.5≥: ESR2 |
| 8 | modafinil | 1.209 | 8.33 (P42261) | PASS | FLAG | Tier 2 z≥1.5≥: CHRNA3 |
| 10 | donepezil | 1.182 | 8.33 (P42261) | FLAG | PASS | Informational Tier 3 z≥1.0≥: NTRK1 |
| 14 | atomoxetine | 1.161 | 8.84 (P48058) | FLAG | PASS | clean |
| 16 | encenicline | 1.157 | 8.33 (P42261) | FLAG | PASS | clean |
| 17 | cx-717 | 1.156 | 8.82 (Q99720) | FLAG | PASS | clean |
| 19 | riluzole | 1.154 | 8.16 (Q01959) | FLAG | PASS | clean |
| 21 | ropinirole | 1.149 | 7.82 (Q08499) | FLAG | PASS | clean |
| 27 | levodopa | 1.128 | 7.73 (Q16620) | FLAG | PASS | clean |
| 29 | enalapril | 1.125 | 7.83 (P42262) | FLAG | FLAG | Composite Tier 2 z≥1.5≥ (2 hits): CHRM3, NR3C1 |
| 30 | amitriptyline | 1.122 | 8.59 (O60741) | FLAG | PASS | clean |
| 31 | nortriptyline | 1.121 | 8.59 (O60741) | FLAG | PASS | clean |
| 32 | venlafaxine | 1.120 | 8.84 (P48058) | FLAG | PASS | Informational Tier 3 z≥1.0≥: GABRA3 |
| 35 | sertraline | 1.118 | 8.33 (P42261) | FLAG | PASS | clean |
| 37 | clomipramine | 1.113 | 7.73 (Q16620) | FLAG | PASS | clean |
| 39 | pitolisant | 1.112 | 7.73 (Q16620) | FLAG | PASS | Informational Tier 3 z≥1.0≥: GABRA3, GABRA5 |
| 40 | olanzapine | 1.110 | 7.82 (Q08499) | FLAG | PASS | clean |
| 43 | cep-26401 | 1.109 | 8.12 (P08913) | FLAG | PASS | clean |
| 47 | fluoxetine | 1.103 | 8.33 (P42261) | FLAG | PASS | clean |
| 50 | chembl4228464 | 1.097 | 7.52 (Q9Y5N1) | PASS | FLAG | Tier 2 z≥1.5≥: NR3C1 |
...
|---|---|---|---|---|---|
| 20 | aripiprazole | 1.150 | FLAG | CUT | Tier 1 within-target z≥2.0≥: CHRM1, MAOA |
| 24 | risperidone | 1.144 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, HRH1, CHRM1, MAOA |
| 46 | lemborexant | 1.104 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, KCNH2, HRH1, CNR1, CHRM1, MAOA |
| 65 | hydroxyzine | 1.069 | FLAG | CUT | Tier 1 within-target z≥2.0≥: KCNH2 |
| 68 | tc-5619 | 1.063 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, CNR1, CHRM1, MAOA |
| 72 | suvorexant | 1.061 | FLAG | CUT | Tier 1 within-target z≥2.0≥: OPRM1, CNR1, CHRM1, MAOA |
| 74 | paroxetine | 1.056 | FLAG | CUT | Tier 1 within-target z≥2.0≥: MAOA |
| 81 | lurasidone | 1.040 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, OPRM1, HRH1, CNR1, CHRM1, MAOA |
| 85 | bpn14770 | 1.037 | FLAG | CUT | Tier 1 within-target z≥2.0≥: OPRM1, CNR1, CHRM1, MAOA |
| 87 | tulrampator | 1.036 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, OPRM1, HRH1, CNR1, CHRM1, MAOA |
| 89 | xen-1101 | 1.034 | FLAG | CUT | Tier 1 within-target z≥2.0≥: KCNH2 |
| 91 | 2bact | 1.030 | FLAG | CUT | Tier 1 within-target z≥2.0≥: KCNH2 |
| 103 | lm22a-4 | 0.990 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, OPRM1, HRH1, CNR1, CHRM1 |
| 114 | methylene blue | 0.855 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HRH1 |
| 118 | naproxen | 0.101 | CUT | UNKNOWN |  |
| 119 | chembl4536304 | 0.098 | CUT | UNKNOWN |  |
| 120 | chembl2151438 | 0.095 | CUT | UNKNOWN |  |
| 121 | chembl353333 | 0.093 | CUT | UNKNOWN |  |
| 122 | sch-23390 | 0.092 | CUT | UNKNOWN |  |
| 123 | chembl331644 | 0.090 | CUT | UNKNOWN |  |
| 124 | chembl596987 | 0.088 | CUT | UNKNOWN |  |
| 125 | chembl28394 | 0.087 | CUT | UNKNOWN |  |
| 126 | chembl1823677 | 0.087 | CUT | UNKNOWN |  |
| 127 | chembl1823887 | 0.085 | CUT | UNKNOWN |  |
| 128 | chembl123132 | 0.084 | CUT | UNKNOWN |  |
...
- data\results\v2\final_ranking_v8_kg.parquet
