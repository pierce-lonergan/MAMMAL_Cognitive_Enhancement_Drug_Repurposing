...
**Pre-registrations**: `reports/paper-drafts/v7_osf_preregistration.md` + `reports/paper-drafts/v8_osf_preregistration.md` (both markdown-ready; OSF.io DOI mint pending).
