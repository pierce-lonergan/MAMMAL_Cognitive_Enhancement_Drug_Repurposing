...
| 3 | memantine | 7.436 | 0.10 | 2 | `flat` | ACHE | 1 |
| 4 | bupropion | 7.430 | 0.09 | 3 | `flat` | ACHE | 1 |
...
| 2 | fluoxetine | 7.424 | 0.14 | 3 | `flat` | ADRA2A | 1 |
| 3 | duloxetine | 7.406 | 0.11 | 2 | `flat` | SLC6A2 | 1 |
...
| # | Compound | Composite | Gini | S(10x) | Category | Top target | Cross-facet count |
|---|---|---|---|---|---|---|---|
| 1 | methylene blue | 7.492 | 0.06 | 6 | `flat` | HRH3 | 1 |
| 2 | pitolisant | 7.464 | 0.14 | 4 | `flat` | HRH3 | 1 |
| 3 | aripiprazole | 7.456 | 0.09 | 1 | `flat` | HRH3 | 4 |
| 4 | citalopram | 7.404 | 0.08 | 3 | `flat` | HRH3 | 1 |
| 5 | quetiapine | 7.387 | 0.09 | 2 | `flat` | HRH3 | 1 |
...
| 2 | lemborexant | 7.408 | 0.13 | 3 | `flat` | HCRTR1 | 9 |
...
| # | Compound | Composite | Gini | S(10x) | Category | Top target | Cross-facet count |
|---|---|---|---|---|---|---|---|
| 1 | pf-04447943 | 6.581 | 0.09 | 1 | `flat` | PDE9A | 1 |
| 2 | bi-409306 | 6.343 | 0.09 | 4 | `flat` | PDE9A | 2 |
| 3 | 2bact | 6.336 | 0.10 | 2 | `flat` | PDE4D | 4 |
| 4 | bpn14770 | 6.314 | 0.12 | 3 | `flat` | PDE4D | 3 |
| 5 | rolipram | 6.195 | 0.10 | 3 | `flat` | PDE4D | 1 |

### other

| # | Compound | Composite | Gini | S(10x) | Category | Top target | Cross-facet count |
|---|---|---|---|---|---|---|---|
| 1 | xen-1101 | 7.304 | 0.10 | 5 | `flat` | KCNQ2 | 1 |
| 2 | tulrampator | 7.059 | 0.08 | 1 | `flat` | SIGMAR1 | 6 |
| 3 | ivabradine | 6.974 | 0.07 | 1 | `flat` | SIGMAR1 | 2 |
| 4 | isrib | 6.901 | 0.12 | 4 | `flat` | SIGMAR1 | 1 |
| 5 | lisinopril | 6.876 | 0.10 | 3 | `flat` | SIGMAR1 | 1 |
...
| 3 | 2bact | 8.917 | 0.10 | `flat` | PDE4D | 4 |
...
| 3 | 2bact | 15.079 | 0.10 | `flat` | PDE4D | 4 |
...
| 5 | risperidone | 9.658 | 0.11 | `flat` | ADRA2A | 3 |
...
| 2bact | 4 | phosphodiesterase #3; PDE4D+CHRNA7 #3; HCN1+KCNQ #3; GRIN2A_pref #1 |
| bpn14770 | 3 | phosphodiesterase #4; DAT+NET #5; GRIN2A_pref #4 |
| suvorexant | 3 | orexinergic #1; HRH3+DRD1 #4; SIGMAR1+NTRK2 #2 |
| risperidone | 3 | glutamatergic_nmda #5; GRIN2A_pref #5; HCRTR1+DRD1 #5 |
