...
*Generated by `reports/methodology_v3.md`. Companion to `README.md`, `design/architecture-and-plans/V4_STATUS_AND_FORWARD_PLAN.md`, `design/architecture-and-plans/V6_ARCHITECTURE_PLAN.md`, `reports/v7_osf_preregistration.md`, `reports/v8_osf_preregistration.md`. Sprint: V6.B.3 production NUTS converged R̂=1.000; V7.4 validation 5/8 P1-P8 PASS; V8 scaffolds shipped; wet-lab shortlist v10 with 3-factor composition.*
