...
**Companion docs**:
- `design/V4_STATUS_AND_FORWARD_PLAN.md` — source-of-truth status
- `design/V6_ARCHITECTURE_PLAN.md` — V6+V7+V8 implementation roadmap
- `reports/methodology_v1.md` + `methodology_v2.md` — historical baselines
...
- **Output**: `reports/wet_lab_shortlist_v4_faceted.md` — 17-facet mechanism-class top-N
...
**Hypothesis audit**: 22 falsifiable claims tracked in `reports/hypothesis_audit_v1.md`. Current verdicts: 19 PASS / 3 DEGRADE / 0 FAIL. The 3 DEGRADE (H4 positive-control top-20%, H5 negative-control suppression, H11 SLC6A3 calibrator drift) are documented honest signal.
...
7. **OSF pre-registration lock** — submit `reports/v7_osf_preregistration.md` + `reports/v8_osf_preregistration.md` to OSF.io BEFORE running steps 4-6 on real data
...
*Generated by `reports/methodology_v3.md`. Companion to `README.md`, `design/V4_STATUS_AND_FORWARD_PLAN.md`, `design/V6_ARCHITECTURE_PLAN.md`, `reports/v7_osf_preregistration.md`, `reports/v8_osf_preregistration.md`. Sprint: V6.B.3 production NUTS converged R̂=1.000; V7.4 validation 5/8 P1-P8 PASS; V8 scaffolds shipped; wet-lab shortlist v10 with 3-factor composition.*
