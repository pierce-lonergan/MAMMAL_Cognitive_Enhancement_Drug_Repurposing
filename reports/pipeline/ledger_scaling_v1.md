...
| + web-researched (verified) | 125 | 49 | 47/49 (96%) | 0.912 | 0.0002 | 77.5% | 0.639 |

Through the cited ledgers (n=47, 20 classes) the pattern is PRESERVED: class-LOCO AUROC 1.000 -> 0.967, classes stay 100% outcome-pure, and 97% of clinical-*g* variance remains between-class (ICC 0.95) - not a small-n artifact of the original 31. The web-researched + human-adjudicated step (n=125) confirms the signal survives scaling: class-LOCO AUROC 0.912; see section 3b.
...
- Current pooled within-class points (members of multi-member, g-varying classes): **58** across 12 classes (avg 4.8/class).
...
- **Scaling**: robust through the cited ledgers (n=47: AUROC 0.967, 100% pure, ICC 0.95); the web-researched + adjudicated n=125 step holds at AUROC 0.91 (0.97 on multi-member classes); see 3b.
