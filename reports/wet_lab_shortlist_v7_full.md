...
|---|---|---|---|---|---|---|---|
| 1 | d-amphetamine | positive_control | 1.185 | 8.74 (P23975) | PASS | PASS | **PASS** |
| 2 | methylphenidate | positive_control | 1.163 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 3 | bupropion | extended_cns | 1.160 | 7.73 (Q16620) | PASS | PASS | **PASS** |
| 4 | aniracetam | named_in_research | 1.122 | 7.62 (Q13224) | PASS | PASS | **PASS** |
| 5 | rasagiline | extended_cns | 1.092 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 6 | pridopidine | named_in_research | 1.085 | 8.12 (P08913) | PASS | PASS | **PASS** |
| 7 | levetiracetam | extended_cns | 1.084 | 9.01 (P23975) | PASS | PASS | **PASS** |
| 8 | lisdexamfetamine | extended_cns | 1.082 | 7.82 (Q08499) | PASS | PASS | **PASS** |
| 9 | lanicemine | named_in_research | 1.069 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 10 | pramiracetam | extended_cns | 1.067 | 9.57 (P48058) | PASS | FLAG | **FLAG** |
| 11 | cx-717 | named_in_research | 1.066 | 8.82 (Q99720) | FLAG | PASS | **FLAG** |
| 12 | rivastigmine | positive_control | 1.064 | 8.37 (P48058) | PASS | PASS | **PASS** |
| 13 | selegiline | extended_cns | 1.064 | 7.73 (Q16620) | PASS | PASS | **PASS** |
| 14 | cx-516 | named_in_research | 1.057 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 15 | guanfacine | extended_cns | 1.050 | 7.73 (Q16620) | PASS | PASS | **PASS** |
| 16 | piracetam | extended_cns | 1.040 | 8.84 (P48058) | PASS | PASS | **PASS** |
| 17 | modafinil | positive_control | 1.040 | 8.33 (P42261) | PASS | FLAG | **FLAG** |
| 18 | atomoxetine | positive_control | 1.035 | 8.84 (P48058) | FLAG | PASS | **FLAG** |
| 19 | donepezil | positive_control | 1.033 | 8.33 (P42261) | FLAG | PASS | **FLAG** |
| 20 | chembl1255723 | chembl_expanded | 1.023 | 9.01 (P23975) | PASS | PASS | **PASS** |
| 21 | pramipexole | extended_cns | 1.023 | 8.16 (Q01959) | PASS | PASS | **PASS** |
| 22 | chembl1256414 | chembl_expanded | 1.020 | 8.82 (Q99720) | PASS | PASS | **PASS** |
| 23 | cep-26401 | named_in_research | 1.020 | 8.12 (P08913) | FLAG | PASS | **FLAG** |
| 24 | chembl302231 | chembl_expanded | 1.018 | 9.01 (P23975) | PASS | PASS | **PASS** |
| 25 | chembl1256378 | chembl_expanded | 1.018 | 9.57 (P48058) | PASS | PASS | **PASS** |
...
|---|---|---|---|---|---|
| 1 | d-amphetamine | positive_control | 1.185 | 8.74 (P23975) | — |
| 2 | methylphenidate | positive_control | 1.163 | 8.16 (Q01959) | — |
| 3 | bupropion | extended_cns | 1.160 | 7.73 (Q16620) | — |
| 4 | aniracetam | named_in_research | 1.122 | 7.62 (Q13224) | — |
| 5 | rasagiline | extended_cns | 1.092 | 8.16 (Q01959) | — |
| 6 | pridopidine | named_in_research | 1.085 | 8.12 (P08913) | — |
| 7 | levetiracetam | extended_cns | 1.084 | 9.01 (P23975) | — |
| 8 | lisdexamfetamine | extended_cns | 1.082 | 7.82 (Q08499) | — |
| 9 | lanicemine | named_in_research | 1.069 | 8.16 (Q01959) | — |
| 10 | rivastigmine | positive_control | 1.064 | 8.37 (P48058) | — |
| 11 | selegiline | extended_cns | 1.064 | 7.73 (Q16620) | — |
| 12 | cx-516 | named_in_research | 1.057 | 8.16 (Q01959) | — |
| 13 | guanfacine | extended_cns | 1.050 | 7.73 (Q16620) | — |
| 14 | piracetam | extended_cns | 1.040 | 8.84 (P48058) | — |
| 15 | chembl1255723 | chembl_expanded | 1.023 | 9.01 (P23975) | — |
| 16 | pramipexole | extended_cns | 1.023 | 8.16 (Q01959) | — |
| 17 | chembl1256414 | chembl_expanded | 1.020 | 8.82 (Q99720) | — |
| 18 | chembl302231 | chembl_expanded | 1.018 | 9.01 (P23975) | — |
| 19 | chembl1256378 | chembl_expanded | 1.018 | 9.57 (P48058) | — |
| 20 | atenolol | negative_control | 1.013 | 7.82 (Q08499) | — |
| 21 | isrib | named_in_research | 1.012 | 8.59 (O60741) | — |
| 22 | rolipram | positive_control | 1.010 | 7.83 (P42262) | — |
| 23 | (r,s)-ampa | chembl_expanded | 1.009 | 9.57 (P48058) | — |
| 24 | chembl608151 | chembl_expanded | 1.007 | 8.96 (P23975) | — |
| 25 | ibuprofen | negative_control | 1.007 | 7.82 (Q08499) | — |
...
|---|---|---|---|---|---|---|
| 10 | pramiracetam | 1.067 | 9.57 (P48058) | PASS | FLAG | Tier 2 z≥1.5≥: ESR2 |
| 11 | cx-717 | 1.066 | 8.82 (Q99720) | FLAG | PASS | clean |
| 17 | modafinil | 1.040 | 8.33 (P42261) | PASS | FLAG | Tier 2 z≥1.5≥: CHRNA3 |
| 18 | atomoxetine | 1.035 | 8.84 (P48058) | FLAG | PASS | clean |
| 19 | donepezil | 1.033 | 8.33 (P42261) | FLAG | PASS | Informational Tier 3 z≥1.0≥: NTRK1 |
| 23 | cep-26401 | 1.020 | 8.12 (P08913) | FLAG | PASS | clean |
| 28 | levodopa | 1.011 | 7.73 (Q16620) | FLAG | PASS | clean |
| 29 | enalapril | 1.011 | 7.83 (P42262) | FLAG | FLAG | Composite Tier 2 z≥1.5≥ (2 hits): CHRM3, NR3C1 |
| 32 | chembl4228464 | 1.008 | 7.52 (Q9Y5N1) | PASS | FLAG | Tier 2 z≥1.5≥: NR3C1 |
| 34 | pitolisant | 1.007 | 7.73 (Q16620) | FLAG | PASS | Informational Tier 3 z≥1.0≥: GABRA3, GABRA5 |
| 36 | chembl91184 | 1.006 | 8.70 (Q01959) | PASS | FLAG | Tier 2 z≥1.5≥: NR3C1 |
| 37 | clomipramine | 1.006 | 7.73 (Q16620) | FLAG | PASS | clean |
| 45 | propranolol | 0.999 | 7.82 (Q08499) | FLAG | PASS | Informational Tier 3 z≥1.0≥: GABRA5 |
| 46 | riluzole | 0.997 | 8.16 (Q01959) | FLAG | PASS | clean |
| 48 | clemastine | 0.990 | 8.59 (O60741) | FLAG | FLAG | Composite Tier 2 z≥1.5≥ (2 hits): MAOB, ESR1 |
| 49 | ropinirole | 0.989 | 7.82 (Q08499) | FLAG | PASS | clean |
| 52 | venlafaxine | 0.983 | 8.84 (P48058) | FLAG | PASS | Informational Tier 3 z≥1.0≥: GABRA3 |
| 55 | nortriptyline | 0.980 | 8.59 (O60741) | FLAG | PASS | clean |
| 57 | encenicline | 0.976 | 8.33 (P42261) | FLAG | PASS | clean |
| 63 | blarcamesine | 0.973 | 7.83 (P42262) | FLAG | PASS | clean |
...
|---|---|---|---|---|---|
| 38 | risperidone | 1.005 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, HRH1, CHRM1, MAOA |
| 54 | lemborexant | 0.982 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, KCNH2, HRH1, CNR1, CHRM1, MAOA |
| 59 | aripiprazole | 0.975 | FLAG | CUT | Tier 1 within-target z≥2.0≥: CHRM1, MAOA |
| 60 | tc-5619 | 0.974 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, CNR1, CHRM1, MAOA |
| 61 | hydroxyzine | 0.973 | FLAG | CUT | Tier 1 within-target z≥2.0≥: KCNH2 |
| 78 | bpn14770 | 0.948 | FLAG | CUT | Tier 1 within-target z≥2.0≥: OPRM1, CNR1, CHRM1, MAOA |
| 80 | tulrampator | 0.947 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, OPRM1, HRH1, CNR1, CHRM1, MAOA |
| 82 | xen-1101 | 0.944 | FLAG | CUT | Tier 1 within-target z≥2.0≥: KCNH2 |
| 83 | suvorexant | 0.942 | FLAG | CUT | Tier 1 within-target z≥2.0≥: OPRM1, CNR1, CHRM1, MAOA |
| 84 | 2bact | 0.940 | FLAG | CUT | Tier 1 within-target z≥2.0≥: KCNH2 |
| 88 | lurasidone | 0.929 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, OPRM1, HRH1, CNR1, CHRM1, MAOA |
| 99 | paroxetine | 0.901 | FLAG | CUT | Tier 1 within-target z≥2.0≥: MAOA |
| 100 | lm22a-4 | 0.900 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HTR2B, OPRM1, HRH1, CNR1, CHRM1 |
| 115 | methylene blue | 0.760 | FLAG | CUT | Tier 1 within-target z≥2.0≥: HRH1 |
...
- data\results\v2\final_ranking_v7_moa.parquet
