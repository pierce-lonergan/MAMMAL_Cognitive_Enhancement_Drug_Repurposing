...
*Generated by `reports/v7_osf_preregistration.md`. Companion to `design/architecture-and-plans/V4_STATUS_AND_FORWARD_PLAN.md` §13.Y and `design/architecture-and-plans/V6_ARCHITECTURE_PLAN.md` V7 section.*
