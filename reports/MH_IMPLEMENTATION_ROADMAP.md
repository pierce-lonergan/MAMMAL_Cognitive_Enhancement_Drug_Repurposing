...
| V6.A Multi-Head DTI | Shipped + drafted | `reports/v6a_paper_draft.md`, `figures/v6a/` | 5-head Bayesian router + Venn-ABERS |
...
| Integration manuscript | Drafted | `reports/integration_paper_draft.md` | Umbrella synthesis |
| Wet-lab handoff | Shipped | `reports/wet_lab_shortlist_v10.md` + `reports/wet_lab_handoff_v1.md` | 8-cell tagged top candidates |
...
| 1.5 | `reports/v6b_paper_draft.md` Methods | Add MH8 § (substrate-mediated flag, biophysical justification, nomenclature disambiguation footnote). Replace 4-gate "DEGRADE" table with "PASS" once 1.3 lands. | Manual review |
...
| 2.7 | `reports/v6b_paper_draft.md` Results | Replace Gate 2 "DEGRADE" + Gate 3 "INSUFFICIENT_DATA" with actual numbers + AUROC curve figure | New `figures/v6b/gate3_auroc.png` |
...
| 3.7 | `reports/v7_paper_draft.md` | (a) Update Methods to describe per-class τ² + population × class interaction; (b) Update Results with 96-cell prior table + 60-anchor expansion + soft envelope; (c) Re-generate F7-3 PMD waterfall | New `figures/v7/pmd_waterfall_v2.png` |
...
| 4.6 | Pre-reg gate validation | G1-G6 from MH3 doc § 6: ICC bounds, leave-cell-line-out R², external concordance vs Gorgogietas 2025 + Anderson 2025 | Update `reports/v8_osf_preregistration.md` with G1-G6 |
| 4.7 | `reports/v8_paper_draft.md` | Add Methods § "Per-cell-line random effect" with mathematical decomposition + cpg0000 calibration + transferability index. Add Limitations L1-L6 from MH3 doc. | New `figures/v8/transferability_histogram.png` |
...
| 5.7 | `reports/v8_paper_draft.md` § Methods | Real-LINCS pretraining + OOD eval methodology; cite Biolord + PerturbNet + scAgents + scDCA benchmark comparators | LINCS chemCPA doc Table 4 |
...
| 6.2 | `reports/v6b_paper_draft.md` | Add MH8 nomenclature disambiguation footnote citing 6+ unrelated database entries |
| 6.3 | `reports/v7_paper_draft.md` | Final attribution table: gap closure from model structure vs anchor expansion vs soft envelope |
| 6.4 | `reports/v8_paper_draft.md` | Add U2OS-to-brain 4-sentence defence paragraph using MH3 transferability index + cpg0000 calibration |
| 6.5 | `reports/integration_paper_draft.md` | Update integration figure: V6.B (4 gates PASS) → V7 (full attribution) → V8 (hierarchical + transferability) end-to-end pipeline |
...
- **Wet-lab handoff to a real collaborator** — `reports/wet_lab_handoff_v1.md` exists; finding the collaborator is out of scope.
