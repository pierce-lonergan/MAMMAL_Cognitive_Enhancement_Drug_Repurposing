...
| Random permutation (2000×) | shuffled | 0.441 ± 0.147 |

Granularity-specific: lumping distinct mechanisms (coarse → 0.62) or shuffling labels (random → 0.44, 0/2000 reaching 1.00, perm p = 0.0005) destroys the signal. It lives at the mechanism-class level — the scientific claim.
