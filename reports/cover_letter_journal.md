...
*Declarations.* No competing interests. No funding. AI coding assistance (Claude, Anthropic) is acknowledged in the manuscript; per ICMJE it is not credited with authorship. Data and code are public under Apache-2.0 (manuscript: CC-BY-4.0); the analysis plan and prospective predictions are deposited as an OSF pre-registration (DOI 10.17605/OSF.IO/V7GP5).
