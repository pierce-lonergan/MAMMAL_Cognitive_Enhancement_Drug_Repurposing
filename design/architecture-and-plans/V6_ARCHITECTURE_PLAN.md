...
| V6 Composition | 4 | Joint-posterior plumbing + wet-lab shortlist re-render | V6.A + V6.B both shipped | `reports/wet-lab/wet_lab_shortlist_v11.md` (shipped as the v10 then v11 grid shortlists) |
