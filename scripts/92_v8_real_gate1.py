...
def main() -> int:
    ...
    # The freshness gate reads this trailer to learn what code this report depends on.
    # Emitted HERE rather than pasted into the .md: a hand-added trailer is erased by the
    # next regeneration, and the report silently goes invisible to the gate again.
    L += ["", "Generated by `scripts/92_v8_real_gate1.py`."]
