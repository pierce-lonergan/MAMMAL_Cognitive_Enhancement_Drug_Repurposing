...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path,
                        default=ROOT / "reports" / "v7_nuts_v1.md")
    ...
    L.append("Full PyMC NUTS effect-size translation with 15-compound anchor "
             "likelihood. Per `reports/v7_osf_preregistration.md` §2-§3.")
    L.append("")
    ...
    L.append("Generated by `scripts/58_v7_nuts_synthetic.py`. V7.4 Stage 2 "
             "validation against `reports/v7_osf_preregistration.md`.")
