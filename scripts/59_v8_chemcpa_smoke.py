...
Outputs:
  ...
  reports/pipeline/v8_chemcpa_smoke_v1.md
"""
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path,
                        default=ROOT / "reports" / "pipeline" / "v8_chemcpa_smoke_v1.md")
    ...
    L.append("Generated by `scripts/59_v8_chemcpa_smoke.py`. V8.2 Stage 2 "
             "validation against `reports/paper-drafts/v8_osf_preregistration.md` §2.3.")
