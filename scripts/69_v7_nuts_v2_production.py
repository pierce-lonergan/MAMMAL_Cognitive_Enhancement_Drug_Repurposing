...
`reports/MH_IMPLEMENTATION_ROADMAP.md` § 3 (Sprint 3 sequencing):
...
Outputs:
  ...
  reports/v7_nuts_v2_production_v1.md
...
def main() -> int:
    ...
    L.append("Generated by `scripts/69_v7_nuts_v2_production.py` (Sprint 3.4). "
             "Cited from `reports/MH_IMPLEMENTATION_ROADMAP.md` § 3 attribution analysis.")
